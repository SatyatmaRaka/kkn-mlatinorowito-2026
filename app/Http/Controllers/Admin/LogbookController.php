...
class LogbookController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if (! $user->anggota_id) {
            abort(403, 'Akun belum terhubung ke data anggota.');
        }
        ...
        return redirect()->route('admin.logbook.index')->with('success', 'Logbook berhasil disimpan.');
    }
    ...
    public function update(Request $request, Logbook $logbook): RedirectResponse
    {
        ...
        return redirect()->route('admin.logbook.index')->with('success', 'Logbook berhasil diperbarui.');
    }
    ...
    public function destroy(Logbook $logbook): RedirectResponse
    {
        ...
        return redirect()->route('admin.logbook.index')->with('success', 'Logbook berhasil dihapus.');
    }

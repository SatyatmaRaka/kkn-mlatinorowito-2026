        ...
        <div class="row g-5 pb-5">
            ...
            <div class="col-12 col-md-5">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <img src="{{ asset('images/logo-kkn.png') }}" alt="Logo KKN Mlatinorowito 2026" class="rounded-circle" style="width: 48px; height: 48px; object-fit: contain;" loading="lazy" decoding="async">
                    <div>

                    ...
                    <tbody>
                        @forelse ($keuangans as $item)
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="btn-group">
                                        <a href="{{ route('admin.keuangan.edit', $item) }}" class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.keuangan.destroy', $item) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus catatan ini?')">
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-4 text-muted">Belum ada catatan keuangan.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>

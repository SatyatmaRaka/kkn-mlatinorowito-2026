<x-app-layout>
    ...
    <div class="card shadow-sm">
        <div class="card-body p-4">
            <form id="galeri-upload-form" action="{{ route('panel.galeri.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('panel.galeri.index') }}" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>

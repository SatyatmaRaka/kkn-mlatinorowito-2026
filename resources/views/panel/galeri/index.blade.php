<x-app-layout>
    <x-slot name="header">
        <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-sm-between gap-3">
            ...
            <a href="{{ route('panel.galeri.create') }}" class="btn btn-primary btn-sm px-3 rounded-pill fw-medium d-flex align-items-center gap-2">
                ...
                <div class="col">
                    <div class="premium-card h-100 border-0 shadow-sm position-relative overflow-hidden group">
                        <div class="position-relative">
                            ...
                            >
                            <form
                                action="{{ route('panel.galeri.destroy', $item->id) }}"
                                method="POST"

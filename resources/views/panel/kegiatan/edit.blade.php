<x-app-layout>
    ...
    <div class="card shadow-sm">
        <div class="card-body p-4">
            <form id="kegiatan-form" action="{{ route('panel.kegiatan.update', $kegiatan->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    >{{ old('deskripsi_singkat', $kegiatan->deskripsi_singkat) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <input type="hidden" name="konten" id="konten" value="{{ old('konten', $kegiatan->konten) }}">
                    @error('konten')
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('panel.kegiatan.index') }}" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>

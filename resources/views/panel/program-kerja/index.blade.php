<x-app-layout>
    <x-slot name="header">
        <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-sm-between gap-3">
            ...
            <a href="{{ route('panel.program-kerja.create') }}" class="btn btn-primary btn-sm px-3 rounded-pill fw-medium d-flex align-items-center gap-2">
                            ...
                            <tr>
                                ...
                                <td class="pe-4 py-3 text-end">
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <a
                                            href="{{ route('panel.program-kerja.edit', $item->id) }}"
                                        ...
                                        <form
                                            action="{{ route('panel.program-kerja.destroy', $item->id) }}"
                                            method="POST"
                                            class="d-inline"

<x-layouts.public>
    ...
    <x-slot:description>{{ $pengaturan['tagline'] ?? 'Website resmi KKN UMK Kelompok Desa Mlatinorowito 2026. Program kerja, anggota tim, kegiatan harian, dan galeri dokumentasi.' }}</x-slot:description>
    ...
    @include('beranda.kegiatan-galeri')

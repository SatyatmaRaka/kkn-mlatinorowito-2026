    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="premium-card border-0">
                <div class="card-header bg-white py-3 px-4 border-bottom d-flex justify-content-between">
                    ...
                    <a href="{{ route('admin.logbook.index') }}" class="btn btn-sm btn-light rounded-pill">Semua</a>
                </div>
                <div class="list-group list-group-flush">
                    @forelse ($logbooks as $logbook)
                        <a href="{{ route('admin.logbook.edit', $logbook) }}" class="list-group-item list-group-item-action px-4 py-3">
        ...
        <div class="col-lg-4">
            <div class="premium-card border-0 p-4 d-grid gap-2">
                ...
                <a href="{{ route('admin.logbook.create') }}" class="btn btn-outline-primary rounded-pill py-3"><i class="bi bi-journal-plus me-2"></i>Tulis Logbook</a>
                <a href="{{ route('admin.absensi.riwayat') }}" class="btn btn-outline-secondary rounded-pill py-3"><i class="bi bi-clock-history me-2"></i>Riwayat Absensi</a>
            </div>
        </div>
    </div>
</x-app-layout>
